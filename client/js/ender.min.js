...
/*!
  ...
  * License MIT
  */
function(a){function f(a){var c=b["$"+a]||window[a];if(!c)throw new Error("Ender Error: Requested module '"+a+"' has not been defined.");return c}function g(a,c){return b["$"+a]=c}function h(a,b){for(var c in b)c!="noConflict"&&c!="_VERSION"&&(a[c]=b[c]);return a}function i(a,b,c){return typeof a=="undefined"?c=[]:typeof a=="string"||a.nodeName||a.length&&"item"in a||a==window?(c=j._select(a,b),c.selector=a):c=isFinite(a.length)?a:[a],h(c,i)}function j(a,b){return i(a,b)}a.global=a;var b={},c=a.$,d=a.require,e=a.provide;a.provide=g,a.require=f,j._VERSION="0.3.8",h(j,{fn:i,ender:function(a,b){h(b?i:j,a)},_select:function(a,b){return typeof a=="string"?(b||document).querySelectorAll(a):a.nodeName?[a]:a}}),h(i,{forEach:function(a,b,c,d){for(c=0,d=this.length;c<d;++c)c in this&&a.call(b||this[c],this[c],c,this);return this},$:j}),j.noConflict=function(b){return a.$=c,b&&(a.provide=e,a.require=d,b(f,g,this)),this},typeof module!="undefined"&&module.exports&&(module.exports=j),a.ender=a.$=a.ender||j}(this),!function(){var a={exports:{}},b=a.exports;
/*!
